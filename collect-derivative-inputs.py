...
if __name__ == "__main__":
	if len(sys.argv) < 2:
		print("Usage:")
		print("collect-derivative-inputs.py folder_of_derivatives_data")
		print("Outputs each network metric to its own csv file")
		print("\nExample")
		print("python collect-derivative-inputs.py metrics")
		sys.exit(1)
	else:
